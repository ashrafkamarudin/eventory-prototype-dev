  ...
  <body>
    ...
    <section style="background: url({{ asset('bootstrap-blog/img/divider-bg.jpg') }}); background-size: cover; background-position: center bottom" class="divider">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h2>You got event you want to promote ? If you do, then help us to help you gather more attention to you and YOUR EVENT !</h2><a href="#" class="hero-link">Find Out More</a>
          </div>
        </div>
      </div>
    </section>
