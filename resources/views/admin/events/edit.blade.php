                            ...
                            <div class="form-group {{ !empty($errors->first('image')) ? 'has-error':'' }}">
                                <div class="input-group">
                                    <div class="box-image" id="box-image1">
                                        ...
                                        @if($event->image)
                                            <img id="ShowImage11" src="{{ url('media/images/'.$event->image) }}"
                    ...
                    <div class="card card-info card-outline">
                        <div class="card-body">
                            <div class="form-group {{ !empty($errors->first('title')) ? 'has-error':'' }}">
                                ...
                                <input type="text" class="form-control" id="title" placeholder="Title" name="title" value="{{ $event->title }}" required>
                            ...
                            <div class="form-group {{ !empty($errors->first('description')) ? 'has-error':'' }}">
                                ...
                                <textarea id="editor" class="form-control" rows="3" placeholder="Content"
                                          name="description">{{ $event->content }}</textarea>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="publish" name="publish" {{ $event->status == 1 ? 'checked':'' }} class="custom-control-input" value="1">
                                    <label class="custom-control-label" for="publish">Publish</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="draft" name="publish" {{ $event->status == 0 ? 'checked':'' }} class="custom-control-input" value="0">
                        ...
                        <div class="card-body">
                            <div class="form-group {{ !empty($errors->first('keyword')) ? 'has-error':'' }}">
                                ...
                                <input type="text" class="form-control" id="keyword" placeholder="Keyword"
                                       name="keyword" value="{{ $event->keyword }}">
