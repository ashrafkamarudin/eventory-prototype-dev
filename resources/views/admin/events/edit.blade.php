                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="publish" name="status" class="custom-control-input" value="1" {{ $event->status == 1 ? 'checked':'' }} >
                                    <label class="custom-control-label" for="publish">Publish</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="draft" name="status" class="custom-control-input" value="0" {{ $event->status == 0 ? 'checked':'' }} >
